                        ...
                        <div style="border:2px solid #E4E6EB;border-radius: 10px;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;min-width:285px;">
                                ...
                                <div style="float:right;width:67%;border: 0px solid #000;text-align:center;padding:5px 0px;line-height:30px;">
                                    <div>
                                        <span style="font-size: 18px;">
                                            <a href="https://{!! strtoupper($key) !!}.masternodes.pro" target="_blank" style="text-decoration: none; color: rgb(66, 139, 202);">{!! $one['name'] !!} ({!! strtoupper($key) !!})</a>
                                        </span>
                                    </div>
                                    <div><span style="font-size: 16px;">${!! number_format($one['currentUSDPrice'],2,'.','') !!} USD</span></div>
                                </div>
                                <div style="text-align:center;padding:5px 0px;width:33%;"><a href="https://{!! strtoupper($key) !!}.masternodes.pro" target="_blank"><img src="{!! $one['logo'] !!}" width="50vw"></a></div>
                            </div>
                            <div style="border-top: 1px solid #E4E6EB;clear:both;">
                                ...
                                <div style="text-align:center;float:left;width:50%;font-size:12px;padding:12px 0 16px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Coins Locked <br><br> <span
                                            style="font-size: 14px; ">{!! number_format($one['totalMasterNodes'] * $one['masterNodeCoinsRequired'],'0','',',') !!}</span></div>
                            </div>
                            <div style="border-top: 1px solid #E4E6EB;clear:both;">
                                <div style="text-align:center;float:left;width:50%;font-size:12px;padding:12px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Required Coin's <br><br> <span style="font-size: 17px; ">{!! $one['masterNodeCoinsRequired'] !!}</span></div>
                                <div style="text-align:center;float:left;width:50%;font-size:12px;padding:12px 0 16px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Node Worth <br><br> <span
                                            style="font-size: 14px; ">${!! number_format($one['currentUSDPrice'] * $one['masterNodeCoinsRequired'],2,'.','') !!}</span></div>
                            </div>
                            <div style="border-top: 1px solid #E4E6EB;clear:both;">
                                <div style="text-align:center;float:left;width:25%;font-size:12px;padding:12px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Daily <br><br> <span style="font-size: 17px; ">${!! $one['income']['daily'] !!}</span></div>
                                <div style="text-align:center;float:left;width:25%;font-size:12px;padding:12px 0 16px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Weekly <br><br> <span style="font-size: 14px; ">${!! $one['income']['weekly'] !!}</span></div>
                                <div style="text-align:center;float:left;width:25%;font-size:12px;padding:12px 0 16px 0;border-right:1px solid #E4E6EB;line-height:1.25em;"> Monthly <br><br> <span style="font-size: 14px; ">${!! $one['income']['monthly'] !!}</span></div>
                                <div style="text-align:center;float:left;width:25%;font-size:12px;padding:12px 0 16px 0;line-height:1.25em;"> Yearly <br><br> <span style="font-size: 14px; ">${!! $one['income']['yearly'] !!}</span></div>
                            </div>
                            <div style="border-top: 1px solid #E4E6EB;text-align:center;clear:both;font-size:10px;font-style:italic;padding:5px 0;">
                                Last Updated <br><br> <span style="font-size: 14px; ">{!! $one['lastUpdated'] !!}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
